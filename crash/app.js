...
class App {
    constructor() {
        ...
        this.bar = new Bar(this.bar_x, this.bar_y, this.bar_width, this.bar_height, this.bar_range,this.bar_yrange);
    ...
    animate() {
        ...
        for (let i = 0; i < this.shape.length; i++) {
            ...
            this.shape[i].crashBar(this.bar.x, this.bar.y, this.bar.width, this.bar.height);
        }
